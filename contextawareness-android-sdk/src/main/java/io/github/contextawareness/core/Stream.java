...
/**
 * Stream is one of the essential classes used in contextawareness.
 * Most personal data access/process operation in contextawareness use Stream as the intermediate.
 *
