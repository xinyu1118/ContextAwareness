...
/**
 * Stream is one of the essential classes used in eventawareness.
 * Most personal data access/process operation in eventawareness use Stream as the intermediate.
 *
